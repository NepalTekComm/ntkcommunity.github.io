    ...
    <footer className="bg-accent text-accent-foreground">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-accent-foreground/80 leading-relaxed mb-6 max-w-md">
              Empowering the next generation of tech innovators at NCIT, Nepal. Join us in building a vibrant community
              of learners, creators, and leaders in technology.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#events" className="text-accent-foreground/80 hover:text-accent-foreground transition-colors">
                  Events
                </a>
              </li>
              <li>
                <a href="#team" className="text-accent-foreground/80 hover:text-accent-foreground transition-colors">
                  Our Team
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-accent-foreground/20 mt-8 pt-8 text-center">
          <p className="text-accent-foreground/60">© 2024 Nepal TeK Community. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
